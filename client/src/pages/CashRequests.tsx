...
export default function CashRequests() {
  ...
  const approveMutation = trpc.cashRequests.approve.useMutation({
    onSuccess: () => { toast.success("Cash request approved"); utils.cashRequests.list.invalidate(); utils.notifications.list.invalidate(); utils.notifications.unreadCount.invalidate(); },
    onError: (err: any) => toast.error(err.message),
  });
  const rejectMutation = trpc.cashRequests.reject.useMutation({
    onSuccess: () => { toast.success("Cash request rejected"); utils.cashRequests.list.invalidate(); },
    onError: (err: any) => toast.error(err.message),
  });
